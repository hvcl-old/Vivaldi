#include "/home/whchoi/vivaldi/src/py-src/helper_math.h"
...
extern "C"{
__global__ void combinningRGBARGBA(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, RGBA* front, VIVALDI_DATA_RANGE* front_DATA_RANGE, RGBA* back, VIVALDI_DATA_RANGE* back_DATA_RANGE, int x_start, int x_end, int y_start, int y_end){
    ...
    rb[(x-rb_DATA_RANGE->buffer_start.x)+(y-rb_DATA_RANGE->buffer_start.y)*(rb_DATA_RANGE->buffer_end.x-rb_DATA_RANGE->buffer_start.x)] = RGBA(ret);
    return;

}
__global__ void rendershort4(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, short4* volume1, VIVALDI_DATA_RANGE* volume1_DATA_RANGE, int x_start, int x_end, int y_start, int y_end){
    ...
    for(float3 elem = line_iter.begin(); line_iter.valid(); ){
        float4 val;
        val = point_query_3d<float4>(volume1, elem, volume1_DATA_RANGE);
...
__global__ void rendershort2(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, short2* volume1, VIVALDI_DATA_RANGE* volume1_DATA_RANGE, int x_start, int x_end, int y_start, int y_end){
    ...
    for(float3 elem = line_iter.begin(); line_iter.valid(); ){
        float2 val;
        val = point_query_3d<float2>(volume1, elem, volume1_DATA_RANGE);
        tmp_val = transfer(val);
...
__global__ void rendershort(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, short* volume1, VIVALDI_DATA_RANGE* volume1_DATA_RANGE, int x_start, int x_end, int y_start, int y_end){
    ...
    for(float3 elem = line_iter.begin(); line_iter.valid(); ){
        float val;
        val = point_query_3d<float>(volume1, elem, volume1_DATA_RANGE);
        tmp_val = transfer(val);
...
__global__ void rendershort3(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, short3* volume1, VIVALDI_DATA_RANGE* volume1_DATA_RANGE, int x_start, int x_end, int y_start, int y_end){
    ...
    for(float3 elem = line_iter.begin(); line_iter.valid(); ){
        float3 val;
        val = point_query_3d<float3>(volume1, elem, volume1_DATA_RANGE);
        tmp_val = transfer(val);
